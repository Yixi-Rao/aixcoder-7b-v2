...
OUTPUT_DIR="models/align_models/aixcoder/0124_dpo_multi_lang"
MODEL_NAME="models/aixcoder/sft-models/checkpoint-892"
DATASET_NAME="dpo/Reject_Sample/aixcoder-0124-python/hf_dataset_multi_lang"
...
docker run -d -it --gpus all --net=host --name $CONTAINER_NAME \
    ...
    -w $WORK_DIR $IMAGE_NAME /bin/bash -c "$CMD"
