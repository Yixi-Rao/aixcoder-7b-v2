...
# Default parameters
OUTPUT_DIR="/models/aixcoder/sft-models"
MODEL_NAME="models/aixcoder/aiXcoder-7b-base-weights-hf"
DATASET_NAME=data/aixcoder/aix_0114_multi_language/sft_train_output_new/combined_output.jsonl
...
do
    ...
    examples/scripts/sft-1206-multi-granularity/sft_aix_base_spm_comment_validation.py \
...
"""
    ...
    EXP_NAME=sft_0124
    LOG_FILE="$WORK_DIR/logs/aix7base_$EXP_NAME.log"
