...
# Default parameters
OUTPUT_DIR="deepseek/sft-models"
MODEL_NAME="models/deepseekcoder-6.7b-base"

# prompt file
DATASET_NAME=data/rq3/deepseekcoder_merge.jsonl
...
do
    ...
    /nfs100/zhuhao/trl_debug/trl-main/trl-main/examples/scripts/0218/sft_ds67base.py \
...
"""
    ...
    EXP_NAME=sft_0219
    LOG_FILE="$WORK_DIR/logs/deepseekcoder_$EXP_NAME.log"
