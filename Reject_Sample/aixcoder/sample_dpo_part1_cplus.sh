...
model_name=aixcoder-0124-cplus
...
if [ "$mode" == "dpo_sample" ]; then
  prompt_files=(
    "dpo_data/cplus_api_output.jsonl"
    "dpo_data/cplus_line_output.jsonl"
    "dpo_data/cplus_structured_span_output.jsonl"
  )
...
# 第五步：执行评估脚本
scripts=(
  "Reject_Sample/eval_api.py"
  "Reject_Sample/eval_line.py"
  "Reject_Sample/eval_span.py"
)
