...
if [ "$mode" == "dpo_sample" ]; then
  prompt_files=(
    "pythondata/rq3/deepseekcoder_dpo/java_api.jsonl"
    "pythondata/rq3/deepseekcoder_dpo/java_line.jsonl"
    "pythondata/rq3/deepseekcoder_dpo/java_structured_span.jsonl"
  )
  work_dir="Reject_Sample"
  seed_data="po_data/java_api.jsonl"
  temperature=1.5
  num_samples=10
  BLEU_threshold=0.6
