# 第一步：定义变量
model_path=models/deepseek/0218-deepseekcoder-7B/sft-models
model_name=deepseek-0223-python
...
if [ "$mode" == "dpo_sample" ]; then
  prompt_files=(
    "pythondata/rq3/deepseekcoder_dpo/python_api.jsonl"
    "pythondata/rq3/deepseekcoder_dpo/python_line.jsonl"
    "pythondata/rq3/deepseekcoder_dpo/python_structured_span.jsonl"
  )
  work_dir="Reject_Sample"
  seed_data="po_data/python_api.jsonl"
  temperature=1.5
  num_samples=10
  BLEU_threshold=0.6
...
docker rm -f inference_

# 第五步：执行评估脚本
scripts=(
  "DPO_dataset/eval_api.py"
  "DPO_dataset/eval_line.py"
  "DPO_dataset/eval_span.py"
)
