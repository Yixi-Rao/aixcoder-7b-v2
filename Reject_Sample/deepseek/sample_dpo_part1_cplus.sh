...
model_name=deepseek-0223-cplus
...
if [ "$mode" == "dpo_sample" ]; then
  prompt_files=(
    "pythondata/rq3/deepseekcoder_dpo/cplus_api.jsonl"
    "pythondata/rq3/deepseekcoder_dpo/cplus_line.jsonl"
    "pythondata/rq3/deepseekcoder_dpo/cplus_structured_span.jsonl"
  )
  work_dir="Reject_Sample"
  seed_data="po_data/cplus_api.jsonl"
  temperature=1.5
  num_samples=10
  BLEU_threshold=0.6
