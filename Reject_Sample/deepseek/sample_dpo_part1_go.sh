...
if [ "$mode" == "dpo_sample" ]; then
  prompt_files=(
    "pythondata/rq3/deepseekcoder_dpo/go_api.jsonl"
    "pythondata/rq3/deepseekcoder_dpo/go_line.jsonl"
    "pythondata/rq3/deepseekcoder_dpo/go_structured_span.jsonl"
  )
