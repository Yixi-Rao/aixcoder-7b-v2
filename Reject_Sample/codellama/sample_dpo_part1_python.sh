# 第一步：定义变量
model_path=models/0218_codellama-7B/sft-models
model_name=codellama-0223-python
...
if [ "$mode" == "dpo_sample" ]; then
  prompt_files=(
    "data/rq3/codellama_po/python_api.jsonl"
    "data/rq3/codellama_po/python_line.jsonl"
    "data/rq3/codellama_po/python_structured_span.jsonl"
  )
