...
model_name=codellama-0223-cplus
...
if [ "$mode" == "dpo_sample" ]; then
  prompt_files=(
    "data/rq3/codellama_po/cplus_api.jsonl"
    "data/rq3/codellama_po/cplus_line.jsonl"
    "data/rq3/codellama_po/cplus_structured_span.jsonl"
  )
